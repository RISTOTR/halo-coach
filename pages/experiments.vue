...
type HistoryItem = {
  ...
  endDate: string | null
  status: string
  outcome: { alignment: string | null; confidenceScore: number | null } | null
}
...
function viewActive() {
  ...
  expFlow.openEndConfirm() // opens confirm date screen
}

function confirmEndActive() {
  dialogOpen.value = true
  expFlow.openEndConfirm() // same: confirm date first ✅
}
